...
推荐从 [Releases](https://github.com/413162826/Codex-Dream-Skin/releases/latest) 下载 `Codex-Dream-Skin-Windows-*-Setup.exe`，双击完成安装。安装器会关闭正在运行的 Dream Skin 托盘和 Codex，校验官方 Codex Store 包和 Node.js，部署受管运行时，并在开始菜单注册启动、检查更新和卸载入口。
